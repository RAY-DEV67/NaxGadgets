  ...
  export function EcommerceCard(props) {
    ...
    return (
      <div className="flex flex-col items-center">
        <div className="flex flex-col items-center">
        <div className="border-y border-[#00A0DE] lg:h-[190px] w-[90vw] lg:w-[100%] flex rounded-[10px]">
          <div className="w-[40%]">
            <img
              src={post.images}
              alt="Product"
          ...
          <div className="ml-[1rem]">
            <div>
              <div className="flex justify-between w-[40vw]">
                <h1 className="text-[#00A0DE] font-bold mt-[0.5rem] text-left">{formatCur(post.price , 'en-NG' , "NGN")}</h1>
                {loading ? (
