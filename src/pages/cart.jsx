          ...
          {!empty && (
            <div>
              ...
              <div onClick={() => {
                ...
                <button className="text-white rounded-[20px] bg-[#00A0DE] font-bold mt-[2rem] py-[0.5rem] px-[1rem]">
                  Check Out
                </button>
              </div>
            </div>
          )}
          <p className="text-white lg:hidden text-center bg-[#00A0DE] fixed text-[10px] w-[4%] left-[93%] top-[3%] z-20 rounded-full">
            {saved.length}
          </p>
        </div>
      ) : (
